	...
	function vibebp_general_settings(){
		...
		switch($_GET['sub']){
			...
			$settings = apply_filters('vibebp_general_settings',array(
					...
					/*array(
						'label' => __('Disable WP Login & Registration','vibebp'),
						'name' => 'disable_default_login_registration',
						'type' => 'checkbox',
						'desc' => __('Disable all login & registration directly in WordPress. Force users to use Social Login methods. Does not apply to Administrators & WooCommerce Logins.','vibebp'),
						'default'=>''
					),*/
					array(
